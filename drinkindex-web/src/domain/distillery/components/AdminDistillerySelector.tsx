...
import { useAllDistilleries } from '../hooks/useDistillery'
...
export default function AdminDistillerySelector({
  value,
  defaultName,
  onChange,
  placeholder = '증류소 선택...',
  ...
  const { data: all = [], isLoading } = useAllDistilleries()
  ...
  useEffect(() => {
    ...
    const handler = (e: MouseEvent) => {
      ...
      const portal = document.getElementById('admin-distillery-selector-portal')
  ...
  const dropdown = open && pos ? (
    <div
      id="admin-distillery-selector-portal"
      style={{
        position: 'fixed',
