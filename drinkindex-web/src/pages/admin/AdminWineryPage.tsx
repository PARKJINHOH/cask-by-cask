...
export default function AdminWineryPage() {
  ...
  const { data, isLoading } = useAdminWineries(keyword, page)
                  ...
                  data.content.map((w) => (
                    <tr key={w.id} className="hover:bg-neutral-50 transition-colors">
                      ...
                      <td className="px-4 py-3 text-neutral-400">
                        {w.website
                          ? <a href={w.website} target="_blank" rel="noopener noreferrer" className="text-primary-600 hover:underline truncate max-w-[140px] inline-block">{w.website}</a>
                          : '-'}
                      </td>
