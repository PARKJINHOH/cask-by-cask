...
// 세 모드(WYSIWYG · HTML 편집 · 미리보기)가 같은 높이 계약(.di-editor-pane / .di-richtext)을 쓴다.
import '@/shared/tiptap/rich-text.css'
    ...
    <div>
      ...
      {isHtmlMode ? (
        ...
        <textarea
          ...
          className="di-editor-pane w-full px-3 py-2.5 font-mono text-xs text-neutral-700 leading-relaxed
            border border-neutral-300 rounded-lg
            focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none"
        />
      ) : htmlModeEverUsed ? (
        /* ── HTML 모드 사용 후 — 미리보기만 (TipTap 변환 방지) ──
           안내 바는 스크롤 밖에 고정하고 본문만 .di-editor-pane 안에서 스크롤한다. */
        <div className="border border-neutral-300 rounded-lg overflow-hidden">
          ...
          <div
            className="di-editor-pane px-4 py-3 notice-content"
