...
export default function ReviewEmbedDialog({ open, onClose, onSelect }: Props) {
  ...
  return (
    <div
      className="di-review-embed-dialog fixed inset-0 z-[60] flex items-start justify-center bg-black/40 p-4 pt-[8vh]"
      onMouseDown={onClose}
    >
      <div
      ...
      >
        <div className="flex items-start justify-between gap-4 border-b border-neutral-100 px-5 py-4">
          ...
          <button
            ...
            className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg text-xl leading-none text-neutral-400 hover:bg-neutral-100 hover:text-neutral-700"
          >
            ×
          </button>
        </div>
