  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8">
      ...
      <header className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        ...
        <Link to="/taste-trees/new" className="inline-flex items-center justify-center rounded-lg bg-primary-800 px-5 py-2.5 text-sm font-bold text-white hover:bg-primary-900">
