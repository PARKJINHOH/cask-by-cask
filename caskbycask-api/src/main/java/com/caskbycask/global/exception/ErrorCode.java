...
public enum ErrorCode {
    ...
    AI_NEWS_EMPTY_CONTENT(HttpStatus.BAD_REQUEST, "AI_NEWS_011", "본문이 없는 소재는 발행할 수 없습니다. 내용을 작성한 후 발행해주세요."),
    ...
    // Venue (주류 장소)
    VENUE_NOT_FOUND(HttpStatus.NOT_FOUND, "VENUE_001", "장소를 찾을 수 없습니다."),
    VENUE_CITY_NOT_FOUND(HttpStatus.NOT_FOUND, "VENUE_002", "도시를 찾을 수 없습니다."),
    VENUE_COORDINATES_REQUIRED(HttpStatus.BAD_REQUEST, "VENUE_003",
            "장소를 공개하려면 지도 위치(좌표)를 먼저 지정해야 합니다."),
    VENUE_COORDINATES_INVALID(HttpStatus.BAD_REQUEST, "VENUE_004", "지도 위치(좌표) 값이 올바르지 않습니다."),
    VENUE_CITY_SLUG_DUPLICATED(HttpStatus.CONFLICT, "VENUE_005", "같은 국가에 이미 사용 중인 도시 주소입니다."),
    VENUE_CITY_IN_USE(HttpStatus.CONFLICT, "VENUE_006",
            "이 도시에 등록된 장소가 있어 삭제할 수 없습니다. 노출을 끄는 것으로 대신해주세요."),
    VENUE_CITY_COUNTRY_IMMUTABLE(HttpStatus.BAD_REQUEST, "VENUE_007",
            "도시의 국가는 변경할 수 없습니다. 다른 국가로 옮기려면 새 도시를 만들어주세요."),
    VENUE_COMMENT_NOT_FOUND(HttpStatus.NOT_FOUND, "VENUE_010", "댓글을 찾을 수 없습니다."),
    VENUE_COMMENT_ACCESS_DENIED(HttpStatus.FORBIDDEN, "VENUE_011", "댓글에 대한 권한이 없습니다."),
    VENUE_COMMENT_NESTED_REPLY_NOT_ALLOWED(HttpStatus.BAD_REQUEST, "VENUE_012",
            "대댓글에는 다시 답글을 달 수 없습니다."),
    VENUE_COMMENT_IMAGE_LIMIT_EXCEEDED(HttpStatus.BAD_REQUEST, "VENUE_013",
            "사진은 최대 5장까지 등록할 수 있습니다."),
    VENUE_COMMENT_IMAGE_SIZE_EXCEEDED(HttpStatus.BAD_REQUEST, "VENUE_014",
            "사진 파일은 장당 10MB를 초과할 수 없습니다."),
    VENUE_COMMENT_IMAGE_TOTAL_SIZE_EXCEEDED(HttpStatus.BAD_REQUEST, "VENUE_015",
            "사진 총 용량은 50MB를 초과할 수 없습니다."),
    VENUE_COMMENT_IMAGE_PLAN_INVALID(HttpStatus.BAD_REQUEST, "VENUE_016",
            "사진 변경 정보가 올바르지 않습니다."),
    VENUE_COMMENT_IMAGE_NOT_FOUND(HttpStatus.NOT_FOUND, "VENUE_017", "사진을 찾을 수 없습니다."),
    VENUE_REQUEST_NOT_FOUND(HttpStatus.NOT_FOUND, "VENUE_020", "장소 등록 요청을 찾을 수 없습니다."),
    VENUE_REQUEST_NOT_EDITABLE(HttpStatus.BAD_REQUEST, "VENUE_021", "이미 처리된 요청입니다."),
