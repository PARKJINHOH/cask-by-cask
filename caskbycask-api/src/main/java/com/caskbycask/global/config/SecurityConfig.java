    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        HttpSecurity chain = http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Spirit management is producer-scoped for PARTNER.
                        ...
                        .requestMatchers("/api/admin/producers/**").hasAnyRole("SUPER_ADMIN", "ADMIN", "PARTNER", "IMPORTER")
                        .requestMatchers("/api/admin/wineries/**").hasAnyRole("SUPER_ADMIN", "ADMIN", "PARTNER", "IMPORTER")
                        .requestMatchers("/api/admin/cognac-houses/**").hasAnyRole("SUPER_ADMIN", "ADMIN", "PARTNER", "IMPORTER")
