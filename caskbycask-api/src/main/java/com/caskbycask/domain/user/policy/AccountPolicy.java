...
public final class AccountPolicy {
    ...
    /** 소식 시스템 계정 닉네임 (가입 예약어) */
    public static final String NEWS_MANAGER_NICKNAME = "소식관리자";
    ...
    public static boolean isReservedNickname(String nickname) {
        return SENTINEL_NICKNAME.equals(nickname) || NEWS_MANAGER_NICKNAME.equals(nickname);
    }
