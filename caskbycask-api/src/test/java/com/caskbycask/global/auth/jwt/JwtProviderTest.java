...
class JwtProviderTest {
    ...
    // 32자 이상 (256bit+) 필수
    private static final String PRIMARY_SECRET  = "caskbycask-test-secret-key-must-be-at-least-32-chars!!";
    private static final String PREVIOUS_SECRET = "caskbycask-PREVIOUS-secret-key-also-at-least-32-chars!";
