-- =============================================================================
-- DrinkIndex 기초데이터 — 숙성력 점수 설정(score_config) + 회원 레벨(member_level_config)
-- =============================================================================
-- 작성 기준일: 2026-06-01
...
--     (체크섬 검증 실패로 기동이 막힙니다. 보정이 필요하면 V13__*.sql 로 추가하세요.)
...
-- -----------------------------------------------------------------------------
-- 회원 레벨 설정 (member_level_config)
-- -----------------------------------------------------------------------------
INSERT IGNORE INTO member_level_config
    (level, name, min_score, is_active, created_at, updated_at)
VALUES
    (1,  '몰트',   0,     1, NOW(6), NOW(6)),
    (2,  '스피릿', 50,    1, NOW(6), NOW(6)),
    (3,  '스카치', 150,   1, NOW(6), NOW(6)),
    (4,  '12yo',  350,   1, NOW(6), NOW(6)),
    (5,  '15yo',  700,   1, NOW(6), NOW(6)),
    (6,  '18yo',  1200,  1, NOW(6), NOW(6)),
    (7,  'CS',    2000,  1, NOW(6), NOW(6)),
    (8,  '21yo',  3500,  1, NOW(6), NOW(6)),
    (9,  '30yo',  6000,  1, NOW(6), NOW(6)),
    (10, '40yo',  10000, 1, NOW(6), NOW(6)),
    (11, '50yo',  20000, 1, NOW(6), NOW(6));
