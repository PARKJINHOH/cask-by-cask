...
public class CognacHouseService {
    ...
    public Page<CognacHouseResponse> search(String keyword, String country, Pageable pageable) {
        ...
        return cognacHouseRepository.search(keywordParam, countryParam, pageable)
