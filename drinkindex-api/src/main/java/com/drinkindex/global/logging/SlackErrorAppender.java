package com.drinkindex.global.logging;
 ...
 *   <appender name="SLACK" class="com.drinkindex.global.logging.SlackErrorAppender">
...
public class SlackErrorAppender extends UnsynchronizedAppenderBase<ILoggingEvent> {
    ...
    private String channel = "#drinkindex-alerts";
