package com.caskbycask.domain.user.batch;

import com.caskbycask.domain.user.entity.User;
import com.caskbycask.domain.user.policy.AccountPolicy;
import com.caskbycask.domain.user.repository.UserRepository;
import com.caskbycask.domain.user.service.AccountHardDeleteService;
...
public class DormantAccountBatch {
    ...
    private String buildPreNoticeBody(String nickname) {
        return """
                ...
                회원님의 CaskByCask 계정이 장기간 미접속으로 %d일 후 휴면 상태로 전환될 예정입니다.
