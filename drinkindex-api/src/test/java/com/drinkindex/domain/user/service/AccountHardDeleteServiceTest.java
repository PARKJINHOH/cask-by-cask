...
class AccountHardDeleteServiceTest {
    ...
    @Autowired private com.drinkindex.domain.user.repository.UserRepository userRepository;
    ...
    void hardDelete_removesUserAndReassignsContent() {
        ...
        // 센티넬 계정 생성됨
        User sentinel = userRepository.findByEmail("withdrawn@drinkindex.system").orElseThrow();
